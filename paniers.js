      ...
      for (var key in result) {
        for (let i = 0; i < produits.length; i++) {
          ...
          if (key == produits[i]._id) {
            ...
            newImage.setAttribute('src', produits[i].imageUrl)
            ...
            newTitres.textContent = produits[i].name;
            //ajout de la description 
            const newDescription = document.createElement('p');
            newDescription.textContent = produits[i].description;
              //ajout de la qty
              const newQty= document.createElement('p');
              newQty.textContent = result[key];
            //ajout du vernis
           // const newVernis = document.createElement('p');
            ...
            newPrix.textContent = "Prix : " + produits[i].price / 100 + ",00 €"
            //appendChild
            ...
            //calcule du total
            sum += parseInt((produits[i].price / 100)*result[key], 10)
