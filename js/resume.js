function resume() { // resumé de la commande
    ...
    newTitres.textContent = 'Merci pour votre commande ' + commande.contact.lastName + ' ' + commande.contact.firstName + ', voici le récapitulatif : ';
